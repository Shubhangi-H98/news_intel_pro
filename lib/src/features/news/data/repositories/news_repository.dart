...
class NewsRepository {
  ...
  Future<List<ArticleModel>> getNews({required String category, int page = 1, int pageSize = 10}) async {
    try {
      ...
      // NAYA LOGIC: Agar category 'all' hai toh category filter nahi bhejenge
